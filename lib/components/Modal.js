...
export class Modal extends React.Component {
    constructor(props) {
        ...
        this.renderCustomBottom = () => {
            ...
            return (React.createElement(View, { style: { position: 'absolute', bottom: 0, left: 0, right: 0, zIndex: 99999 } },
                React.createElement(BottomComponent, { isFirstStep: isFirstStep, isLastStep: isLastStep, currentStep: currentStep, handleNext: this.handleNext, handlePrev: this.handlePrev, handleStop: this.handleStop })));
        };
    }
